...
class ScrollEffects extends StylePluginBase {
  ...
  public function submitConfigurationForm(array &$form, FormStateInterface $form_state) {
    $this->config()
      ...
      ->set('scroll_effects_advanced_settings', $form_state->getValue('scroll_effects_advanced_settings'))
      ->save();
  }
  ...
  public function buildStyleFormElements(array &$form, FormStateInterface $form_state, $storage) {
    $show_advanced_settings = $this->config()->get('scroll_effects_advanced_settings');
    ...
    if(isset($show_advanced_settings)) {
      ...
      $form['advanced']['options']['anchor_placement'] = [
        '#type' => 'select',
        '#title' => $this->t('Anchor Placement') . ' <span class="bs-icon bs-icon--more-info"></span><div class="bs_tooltip bs_tooltip-lg" data-placement="top" role="tooltip">' . $this->t('Defines which position of the element (relative to the window), should trigger the animation. Default: Top Bottom') . '</div>',
        '#options' => [
      ...
      $form['advanced']['options']['anchor_element'] = [
        '#type' => 'textfield',
        '#title' => $this->t('Anchor Element') . ' <span class="bs-icon bs-icon--more-info"></span><div class="bs_tooltip bs_tooltip-lg" data-placement="top" role="tooltip">' . $this->t('Trigger animation on one element, while you scroll to another - useful in animating fixed elements.') . '</div>',
      ...
      $form['advanced']['options']['easing_functions'] = [
        '#type' => 'select',
        '#title' => $this->t('Easing Type') . ' <span class="bs-icon bs-icon--more-info"></span><div class="bs_tooltip bs_tooltip-lg" data-placement="top" role="tooltip">' . $this->t('Default easing for AOS animations. Default: Ease') . '</div>',
        '#options' => [
          'ease' => $this->t('Ease'),
